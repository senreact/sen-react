...
| **3 — Content engine** | News/blog collection (weekly, by sector, moderated comments), Publications collection (downloadable PDFs, fully open per D020), Videos (YouTube embed, FR + Wolof subtitle slot, downloadable per D016) | D016, D019/A4, D020 |
...
| **8 — Community** | Forums by sector, groups by region/sector/theme, events calendar (in-person + online), webinars, mentor-mentee matching, REACT announcements, **occasional REACT-led surveys** (D020 minimal civic scope, no broader civic platform) | D016, D020 |
